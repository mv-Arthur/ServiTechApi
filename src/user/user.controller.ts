...
export class UserController {
  ...
  @Get("/orders")
  async getOrdersForOperator(
    @Query() query: { userId?: number; role?: "operator" | "user" }
  ) {
  ...
  @Get("/sendReport/:id")
  async sendReport(@Param("id") operatorId: number) {
    return await this.orderService.sendOperatorReport(operatorId);
  }

  @Get("/getReport")
  async getReport(@Param("id") operatorId: number) {
    return await this.orderService.getAllReports();
  }
}
